...
| 구분 | 제목 | 내용 |
| --- | --- | --- |
| 오리엔테이션 (무료) | Claude Code & AI 에이전트 기초 | Claude Code와 AI 에이전트 기초, Next.js·Flutter·Supabase 개념, GitHub 사용법을 익히고 뉴스/SNS 등 오픈소스를 활용해 첫 번째 서비스를 만들어봅니다. AI와 협업하는 개발 방식을 익힙니다. |
| 1주차 | 프로젝트 시작 | 커머스 또는 플랫폼 오픈소스를 기반으로 내 서비스 제작을 시작합니다. 프로젝트 구조를 이해하고 UI/UX를 내 아이디어에 맞게 수정하며, GitHub 협업과 Claude Agent를 활용한 개발 워크플로를 익힙니다. |
